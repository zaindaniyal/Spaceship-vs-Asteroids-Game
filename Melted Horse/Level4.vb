Public Class Level4
    ...
    'thse are all the global variables i've used.
    ...
    Dim isMeltedUp As Boolean = True





        'this bottom sub runs when the form loads.
    Private Sub level4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        sr71 = New Plane
    ...
    End Sub
        ...
        Private Sub tmrPlane_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrPlane.Tick
            ...
            'notice this time level 3 is made the hardest....just by one touch the plane can lose a lot of energy.. 
            ...
            'notice a different decision window opens this time.(not effeicient)
            If pctGreenEnergy.Width <= 0 Then
            Decision4.Visible = True
            pctPlane.Left = 10
            pctPlane.Top = 264
        ...
        End If
            ...
            'notice 4 more pictureboxes have been introduced to not allow the plane to find it easy.....(its supposed to be very hard...)
            If pctPlane.Bounds.IntersectsWith(pctXtraTopBoundry.Bounds) Then
                pctPlane.Top = pctPlane.Top + speed
            End If

            If pctPlane.Bounds.IntersectsWith(pctXXtraBottomBoundry.Bounds) Then
                pctPlane.Top = pctPlane.Top + speed
            End If

            If pctPlane.Bounds.IntersectsWith(pctXtraBottomBoundry.Bounds) Then
                pctPlane.Top = pctPlane.Top + speed
            End If
            ...
            'If pctPlane.Bounds.IntersectsWith(pcta

        If pctPlane.Bounds.IntersectsWith(pctAsteroid4.Bounds) Then
            sr71.damage(75)
        End If

        If pctPlane.Bounds.IntersectsWith(pctAsteroid5.Bounds) Then
            sr71.damage(75)
        End If
        ...
        Dim asteroid3speed As Integer = 60
            ...
            'the next set of code is for asteroid 4.
        ...
        'the next set of code is for asteroid 5
        If isMeltedUp = True Then
            pctAsteroid5.Top = pctAsteroid5.Top - asteroid3speed
        End If

        If isMeltedUp = False Then
            pctAsteroid5.Top = pctAsteroid5.Top + asteroid3speed

        End If
        If pctAsteroid5.Bounds.IntersectsWith(pctXtraTopBoundry.Bounds) Then
            isMeltedUp = False
        End If


        If pctAsteroid5.Bounds.IntersectsWith(pctXtraBottomBoundry.Bounds) Then
            isMeltedUp = True
        End If

        End Sub

        'this bottom sub is for the slowest asteroid.
